 ...
 * are used to notify the application when an action completes<li>
 * </ol>
 *
...
public class MqttSubscriber implements MqttCallback {
    ...
    public static void main(String[] args) {
        MqttSubscriber s = new MqttSubscriber();
        s.listenToMQTTStream();
    }

    public void listenToMQTTStream() {
        ...
        String subTopic = "sunfounder_demo/stream";
        // String pubTopic 	= "sunfounder_demo/cmd";
        ...
        if (clientId == null || clientId.equals("")) {
            clientId = "MqttSubscriber_" + action;
        }
        System.out.println(">>> MqttSubscriber.ready() ");
        System.out.println(">>> MqttSubscriber.sender: " + streamSender);

        // With a valid set of arguments, the real work of
        // driving the client API can begin
        try {
            // Create an instance of this class
            MqttSubscriber sc = new MqttSubscriber(url, clientId, cleanSession, quietMode, userName, password);

            // Perform the requested action
            if (action.equals("publish")) {
                // sampleClient.publish(topic,qos,message.getBytes());
            } else if (action.equals("subscribe")) {
                sc.subscribe(topic, qos);
            }
     ...
     */
    public MqttSubscriber(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName, String password) throws MqttException {
    ...
    public void messageArrived(String topic, MqttMessage message) throws MqttException {
        ...
        String topicOut = topic.replace("/", "_");
  
        streamSender.send(topicOut, data);
        
        System.out.println(">>>> {DEVICE => CLUSTER} Life stream message   \n"
                         + "     Content         : " + data);
        System.out.println("     TOPIC IN        : " + topic);
        System.out.println("     TOPIC OUT       : " + topicOut);
        System.out.println("     SENDER          : " + this.getClass().getName() + "\n");
    ...
    static PublishViaKafka streamSender = null;

    public static void setStreamSender(PublishViaKafka s) {
        streamSender = s;
        System.out.println(streamSender);
    }

    public void run() {
        System.out.println(">>> MqttSubscriber.run() ");
        listenToMQTTStream();
    }
