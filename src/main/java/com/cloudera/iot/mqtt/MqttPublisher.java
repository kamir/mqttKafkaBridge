...
import static com.cloudera.iot.mqtt.MqttSubscriber.streamSender;
...
public class MqttPublisher implements MqttCallback {
	...
	public static void sendMessage(String topic, String message) {
		...
		int port 		= 1888;
		String clientId 	= "BridgeClient"; 
                
		String pubTopic 	= "sunfounder_demo_cmd";
    ...
    String url = protocol + broker + ":" + port;
		...
		try {
			...
			MqttPublisher sampleClient = new MqttPublisher(url, clientId, cleanSession, quietMode,userName,password);
   ...
   * @param password the password for the user
	 ...
	 */
    public MqttPublisher(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName, String password) throws MqttException {
    ...
    public void publish(String topicName, int qos, byte[] payload) throws MqttException {
        ...
        System.out.println(">>>> {CLUSTER => DEVICE} Command message   \n" +
                           "     Content         : " + new String( payload ) );
        System.out.println("     TOPIC IN        : " + topicName );
        System.out.println("     TOPIC OUT       : " + topicName );
